...
public class CoalPerceptionEffect extends MobEffect {
    public CoalPerceptionEffect(MobEffectCategory mobEffectCategory, int color) {
                ...
                for (int y = -range; y <= range; y++) {
                    for (int z = -range; z <= range; z++) {
                        ...
                        if(distance <= 16) {
                            ...
                            if (block.builtInRegistryHolder().is(coalOreTag) || block == Blocks.COAL_BLOCK) {
