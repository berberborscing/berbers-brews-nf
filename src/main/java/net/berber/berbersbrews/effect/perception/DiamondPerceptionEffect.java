...
public class DiamondPerceptionEffect extends MobEffect {
    public DiamondPerceptionEffect(MobEffectCategory mobEffectCategory, int color) {
                ...
                for (int y = -range; y <= range; y++) {
                    for (int z = -range; z <= range; z++) {
                        ...
                        if(distance <= 16) {
                            ...
                            if (block.builtInRegistryHolder().is(diamondOreTag) || block == Blocks.DIAMOND_BLOCK) {
