...
public class EmeraldPerceptionEffect extends MobEffect {
    public EmeraldPerceptionEffect(MobEffectCategory mobEffectCategory, int color) {
                ...
                for (int y = -range; y <= range; y++) {
                    for (int z = -range; z <= range; z++) {
                        ...
                        if(distance <= 16) {
                            ...
                            if (block.builtInRegistryHolder().is(emeraldOreTag) || block == Blocks.EMERALD_BLOCK) {
