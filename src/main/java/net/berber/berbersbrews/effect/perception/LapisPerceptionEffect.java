...
public class LapisPerceptionEffect extends MobEffect {
    public LapisPerceptionEffect(MobEffectCategory mobEffectCategory, int color) {
                ...
                for (int y = -range; y <= range; y++) {
                    for (int z = -range; z <= range; z++) {
                        ...
                        if(distance <= 16) {
                            ...
                            if (block.builtInRegistryHolder().is(lapisOreTag) || block == Blocks.LAPIS_BLOCK) {
